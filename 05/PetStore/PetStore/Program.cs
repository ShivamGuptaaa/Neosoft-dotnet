...
namespace PetStore
{
    class Program
    {
        ...
        private static void GetCatByIdDisArch(string conStr, int id)
        {
            SqlConnection connection;
            ...
            try
            {
                var cat = DisconnectedArchitecture.GetCatById(conStr, id, out connection, out adapter, out ds);
